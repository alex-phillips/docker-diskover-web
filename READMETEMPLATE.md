...
# alexphillips/diskover-web

[diskover-web](https://github.com/shirosaidev/diskover-web) is a web file manager, disk space usage, storage search engine and file system analytics for diskover powered by Elasticsearch
...
Access the WebUI at <your-ip>:8000. For more information, check out [diskover-web](https://github.com/shirosaidev/diskover-web).
